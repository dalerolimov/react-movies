...
export default function MovieTheatersForm(props: movieTheaterForm) {
...
interface movieTheaterForm {
    ...
    onSubmit(values: movieTheatersCreationDTO, action: FormikHelpers<movieTheatersCreationDTO>): void;
}